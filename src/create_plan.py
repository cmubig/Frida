...
def define_prompts_dictionary():
    ...
    prompts_dictionary['Painting0']['InitialPrompt'] = 'A black and white sharpie line drawing with a sizeable blank border and blank background of a single tree.'
    prompts_dictionary['Painting1']['InitialPrompt'] = 'A black and white sharpie line drawing with a sizeable blank border and blank background of a simple park with a bench.'
    prompts_dictionary['Painting2']['InitialPrompt'] = 'A black and white sharpie line drawing with a sizeable blank border and blank background of a rainy city street.'
    prompts_dictionary['Painting3']['InitialPrompt'] = 'A black and white sharpie line drawing with a sizeable blank border and blank background of a mountain silhouette.'
    prompts_dictionary['Painting4']['InitialPrompt'] = 'A black and white sharpie line drawing with a sizeable blank border and blank background of a small boat sailing on a lake.'
    prompts_dictionary['Painting5']['InitialPrompt'] = 'A black and white sharpie line drawing with a sizeable blank border and blank background of a ruins of an italian building.'
    prompts_dictionary['Painting6']['InitialPrompt'] = 'A black and white sharpie line drawing with a sizeable blank border and blank background of a desert with undulating sand dunes'
    prompts_dictionary['Painting7']['InitialPrompt'] = 'A black and white sharpie line drawing with a sizeable blank border and blank background of a twilight suburban street.'
    prompts_dictionary['Painting8']['InitialPrompt'] = 'A black and white sharpie line drawing with a sizeable blank border and blank background of a park trail with trees on either side.'
    prompts_dictionary['Painting9']['InitialPrompt'] = 'A black and white sharpie line drawing with a sizeable blank border and blank background of a simple grassy plain.'

    prompts_dictionary['Painting0']['MediumSubsequentPrompt'] = 'A black and white sharpie line drawing of a hilly landscape and a single tree on top of it.'
    prompts_dictionary['Painting1']['MediumSubsequentPrompt'] = 'A black and white sharpie line drawing of a quiet park with a single bench beneath a single tree.'
    prompts_dictionary['Painting2']['MediumSubsequentPrompt'] = 'A black and white sharpie line drawing of a rainy city street with puddles reflecting streetlights.'
    prompts_dictionary['Painting3']['MediumSubsequentPrompt'] = 'A black and white sharpie line drawing of a mountain range with sparse alpine trees.'
    prompts_dictionary['Painting4']['MediumSubsequentPrompt'] = 'A black and white sharpie line drawing of a boat sailing on a pretty lake with small waves'
    prompts_dictionary['Painting5']['MediumSubsequentPrompt'] = 'A black and white sharpie line drawing of a italian monument in Rome'
    prompts_dictionary['Painting6']['MediumSubsequentPrompt'] = 'A black and white sharpie line drawing of a undulating sand dunes with a few palm trees'
    prompts_dictionary['Painting7']['MediumSubsequentPrompt'] = 'A black and white sharpie line drawing of a twilight suburban street with a few buildings.'
    prompts_dictionary['Painting8']['MediumSubsequentPrompt'] = 'A black and white sharpie line drawing of a forest scene with a log cabin in the middle with lush trees in the background.'
    prompts_dictionary['Painting9']['MediumSubsequentPrompt'] = 'A black and white sharpie line drawing of a grassy plain with one or two trees.'

    prompts_dictionary['Painting0']['GoodSubsequentPrompt'] = 'A black and white sharpie line drawing of a single majestic tree with a majestic mountain range in the background.'
    prompts_dictionary['Painting1']['GoodSubsequentPrompt'] = 'A black and white sharpie line drawing of a serene city park with a quiet park bench beneath a canopy of several majestic trees.'
    prompts_dictionary['Painting2']['GoodSubsequentPrompt'] = 'A black and white sharpie line drawing of a rainy city street with puddles reflecting streetlights and umbrellas and a starry sky.'
    prompts_dictionary['Painting3']['GoodSubsequentPrompt'] = 'A black and white sharpie line drawing of a serene snow-capped mountain range with a lush forest of alpine trees on the base of the mountain'
    prompts_dictionary['Painting4']['GoodSubsequentPrompt'] = 'A black and white sharpie line drawing of a majestic ship sailing on waves on the ocean with a city skyline in the background.'
    prompts_dictionary['Painting5']['GoodSubsequentPrompt'] = 'A black and white sharpie line drawing of a majestic Collesium scene from Rome.'
    prompts_dictionary['Painting6']['GoodSubsequentPrompt'] = 'A black and white sharpie line drawing of a beautiful desert oasis with palm trees and a water body with sand dunes in the background.'
    prompts_dictionary['Painting7']['GoodSubsequentPrompt'] = 'A black and white sharpie line drawing of a twilight suburban street with a charming buildings and trees lining the street.'
    prompts_dictionary['Painting8']['GoodSubsequentPrompt'] = 'A black and white sharpie line drawing of a charming rustic cabin in a lush forested woodland.'
    prompts_dictionary['Painting9']['GoodSubsequentPrompt'] = 'A black and white sharpie line drawing of a beautiful mountainous scene with lush fir trees.'
