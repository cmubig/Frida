...
def define_prompts_dictionary():
    ...
    prompts_dictionary['Painting0']['InitialPrompt'] = 'A black and white sparse minimalist sharpie line drawing with a blank background of a single tree.'
    prompts_dictionary['Painting1']['InitialPrompt'] = 'A black and white sparse minimalist sharpie line drawing with a blank background of a simple park with a bench.'
    prompts_dictionary['Painting2']['InitialPrompt'] = 'A black and white sparse minimalist sharpie line drawing with a blank background of a rainy city street.'
    prompts_dictionary['Painting3']['InitialPrompt'] = 'A black and white sparse minimalist sharpie line drawing with a blank background of a mountain silhouette.'
    prompts_dictionary['Painting4']['InitialPrompt'] = 'A black and white sparse minimalist sharpie line drawing with a blank background of a small boat sailing on a lake.'
    prompts_dictionary['Painting5']['InitialPrompt'] = 'A black and white sparse minimalist sharpie line drawing with a blank background of a ruins of an italian building.'
    prompts_dictionary['Painting6']['InitialPrompt'] = 'A black and white sparse minimalist sharpie line drawing with a blank background of a desert with undulating sand dunes'
    prompts_dictionary['Painting7']['InitialPrompt'] = 'A black and white sparse minimalist sharpie line drawing with a blank background of a twilight suburban street.'
    prompts_dictionary['Painting8']['InitialPrompt'] = 'A black and white sparse minimalist sharpie line drawing with a blank background of a park trail with trees on either side.'
    prompts_dictionary['Painting9']['InitialPrompt'] = 'A black and white sparse minimalist sharpie line drawing with a blank background of a simple grassy plain.'
